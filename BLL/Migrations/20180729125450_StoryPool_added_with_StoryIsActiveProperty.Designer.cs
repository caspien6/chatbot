...
namespace BLL.Migrations
{
    ...
    [Migration("20180729125450_StoryPool_added_with_StoryIsActiveProperty")]
    partial class StoryPool_added_with_StoryIsActiveProperty
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BLL.Models.Game.Station", b =>
                {
                    ...
                    b.Property<string>("ConnectionCommand");
            ...
            modelBuilder.Entity("BLL.Models.Game.StoryPool", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int?>("StarterStationId");

                    b.Property<string>("Title");

                    b.HasKey("Id");

                    b.HasIndex("StarterStationId");

                    b.ToTable("StoryPools");
                });
            ...
            modelBuilder.Entity("BLL.Models.Game.StoryPool", b =>
                {
                    b.HasOne("BLL.Models.Game.Station", "StarterStation")
                        .WithMany()
                        .HasForeignKey("StarterStationId");
                });
